...
_TOKENS_CSS = (
    ...
    "--bg:#fbf9fa;--bg-soft:#f3edf0;--bg-card:#fbf9fa;--bg-elev:#f7f3f5;"
    "--fg:#211a1e;--fg-soft:#666063;--fg-faint:#908c8e;"
    "--accent:#7d2f57;--accent-deep:#5a223f;--accent-soft:#ede3e8;"
    "--accent-glow:rgba(125,47,87,.14);"
    "--on-accent:#f3edf0;"
    "--border:#e6dfe3;--border-strong:#d9ced4;"
    "--ok:#2a6f41;--warn:#6f4f2a;--danger:#b3261e;"
    "--shadow:0 1px 2px rgba(34,27,31,.06),0 6px 20px -12px rgba(34,27,31,.22);"
    "--shadow-lg:0 2px 6px rgba(34,27,31,.07),0 18px 40px -22px rgba(34,27,31,.35);"
